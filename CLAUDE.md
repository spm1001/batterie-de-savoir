...
- **Vocabulary and key-repos tables have rows outside the GENERATED markers** — the "Brigade" row and GTD terms in vocabulary, and the "This docs site" row in key-repos, are static and intentionally excluded from generation.
